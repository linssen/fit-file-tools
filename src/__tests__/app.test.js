...
describe("FitFileApp", () => {
    ...
    test("should instantiate correctly", () => {
        ...
        expect(app.fitParser).toBeDefined();
    });
    ...
    test("should generate file info HTML correctly", () => {
        ...
        const html = app.generateFileInfoHTML(mockFile, mockFitData);
    ...
    test("should generate data display HTML correctly", () => {
        ...
        const html = app.generateDataDisplayHTML(mockFitData);
    ...
    test("should handle file reading", async () => {
        ...
        const buffer = await app.readFileAsArrayBuffer(mockFile);
